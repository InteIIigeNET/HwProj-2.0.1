...
namespace HwProj.CourseWorkService.API.Controllers
{
    ...
    public class ReviewerCourseWorksController : ControllerBase
    {
        ...
        public ReviewerCourseWorksController(IBiddingService biddingService, ICourseWorkService courseWorkService,
        ...
        public async Task<IActionResult> CreateBid([FromBody]CreateBid createBid)
        {
            var bid = _mapper.Map<Bid>(createBid);
