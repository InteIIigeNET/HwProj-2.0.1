...
class App extends Component<{ navigate: any }, AppState> {
  constructor(props: { navigate: any }) {
    ...
    appBarStateManager.setOnContextActionChange((appBarState) =>
      this.setState({ appBarContextAction: appBarState }),
    );
  }
      ...
      <>
        ...
        <Routes>
          <Route element={<AuthLayout />}>
            <Route
              path="user/edit"
              element={<EditProfile isExpert={this.state.isExpert} />}
            />
            ...
            <Route
              ...
              element={
                <Notifications
                  onMarkAsSeen={this.updatedNewNotificationsCount}
                />
              }
            />
            <Route
          ...
          <Route
            path="statistics/:courseId/charts"
            element={<StudentStatsChart />}
          />
          ...
          <Route
            path="join/:token"
            element={<ExpertAuthLayout onLogin={this.login} />}
          />
