...
// TODO: commented this in order to make request to the port the service is running on
...
export class BaseAPI {
    // TODO: fix
    // protected configuration: Configuration; commented this manually

    // added this manually in order to make it compile
...
export const AccountApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiAccountEditPut(model?: EditAccountViewModel, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
         ...
         * @throws {RequiredError}
         */
        apiAccountGetCurrentUserDataGet(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = AccountApiFetchParamCreator(configuration).apiAccountGetCurrentUserDataGet(options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response;
         ...
         * @throws {RequiredError}
         */
        apiAccountInvitenewlecturerPost(model?: InviteLecturerViewModel, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
         ...
         * @throws {RequiredError}
         */
        apiAccountLoginPost(model?: LoginViewModel, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
         ...
         * @throws {RequiredError}
         */
        apiAccountRegisterPost(model?: RegisterViewModel, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
...
export const AccountApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        ...
        apiAccountGetCurrentUserDataGet(options?: any) {
            return AccountApiFp(configuration).apiAccountGetCurrentUserDataGet(options)(fetch, basePath);
        },
        /**
         * 
         * @param {string} userId 
...
export class AccountApi extends BaseAPI {
    ...
    public apiAccountGetCurrentUserDataGet(options?: any) {
        return AccountApiFp(this.configuration).apiAccountGetCurrentUserDataGet(options)(this.fetch, this.basePath);
    }
