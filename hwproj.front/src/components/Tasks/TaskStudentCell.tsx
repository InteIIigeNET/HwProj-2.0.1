...
> {
  ...
  getLastSolution = (solutions: StatisticsCourseSolutionsModel[] | undefined): StatisticsCourseSolutionsModel | undefined => {
  ...
  async componentDidMount() {
    const solution = this.getLastSolution(this.props.solutions)
