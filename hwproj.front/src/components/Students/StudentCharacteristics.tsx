...
const EditStudentCharacteristics: React.FC<Props & { onCancel: () => void, isOpen: boolean }> = (props) => {
        ...
        >
            ...
            <DialogContent>
                <Grid container direction={"column"} spacing={1}>
                    <Grid item>
                        <Alert severity="info">
                            Студент не будет видеть характеристику, но она будет доступна другим преподавателям курса
                        </Alert>
                    </Grid>
                    <Grid item>
                        <Typography variant={"body2"}>
                            Добавьте перед характеристикой '-' для отрицательной оценки
                            <br/>
                            или '+' для положительной.
                            <br/>
                            Не указывайте, если хотите указать нейтральную характеристику
                        </Typography>
                    </Grid>
                    <Grid item>
                        <Autocomplete
