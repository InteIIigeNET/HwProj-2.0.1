...
export type AppBarContextAction =
  | { actionName: string; link: string }
  | null
  | "Default";

class AppBarStateManager {
  private _handler:
    | ((state: AppBarContextAction) => void)
    | undefined = undefined;

  public setOnContextActionChange(
    handler: (state: AppBarContextAction) => void,
  ) {
...
export const Header: React.FC<AppBarProps> = (props: AppBarProps) => {
  ...
  const [isOpenInviteLecturer, setIsOpenInviteLecturer] = useState<boolean>(
    false,
  );
  const contextAction =
    props.contextAction === "Default"
      ? {
          actionName: "Курсы",
          link: "/courses",
        }
  ...
  return (
    ...
    >
          ...
          <div>
            ...
            >
              ...
              <Link
                ...
                to={"/experts"}
              >
                <MenuItem>К списку экспертов</MenuItem>
              </Link>
              <Link
                color={"initial"}
                ...
                to={"/create_course"}
              >
                <MenuItem>Создать курс</MenuItem>
              </Link>
      ...
      {isOpenInviteLecturer && (
        <InviteLecturerModal
          isOpen={isOpenInviteLecturer}
          close={closeInviteLecturer}
        />
      )}
    </AppBar>
  );
