...
namespace HwProj.CoursesService.API.Migrations
{
    ...
    [Migration("20240406191646_AddTagsToHomeworks")]
    partial class AddTagsToHomeworks
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HwProj.CoursesService.API.Models.Tag", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("HwProj.CoursesService.API.Models.TagMate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("HwProj.CoursesService.API.Models.Tag", b =>
                {
                    b.HasOne("HwProj.CoursesService.API.Models.Homework")
                        .WithMany("Tags")
                        .HasForeignKey("HomeworkId");
                });
