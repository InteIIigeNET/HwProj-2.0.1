...
Также мы рекомендуем посмотреть [интерактивную презентацию](Docs/InteractivePresentation.pdf), которая наглядно демонстрирует ключевые возможности сервиса.
